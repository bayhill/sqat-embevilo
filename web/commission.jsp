            ...
            <div class="span9">
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <%
                            Database.connect();
                            final ResultSet rs = Database.query("SELECT s.salesmanid, sm.name, s.gunpartid, " +
                                    "gp.description, SUM(s.quantity), SUM(s.quantity*p.price) FROM sales s," +
                                    " salesman sm, gunpart gp, production p WHERE s.gunsmithid = " +
                                    ...
                                    "p.gunpartid = s.gunpartid GROUP BY s.salesmanid, s.gunpartid " +
                                    "ORDER BY s.salesmanid, s.gunpartid");
                            ...
                            if(rs.next()) {
                                ...
                                while(!rs.isAfterLast()) {
                                    ...
                                    while(rs.getInt(1) == currentSalesman) {
                                        ...
                                        <b>Profit:</b> $<%=total-commission%><br/>
                                        <%
                                }
                            %>
                            <hr>
                            ...
                            <b>Profit:</b> $<%=overallTotal-overallCommission%><br/><br/>
                        <%
                            } else {
